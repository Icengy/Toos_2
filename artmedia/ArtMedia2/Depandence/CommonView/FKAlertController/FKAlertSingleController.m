...
@interface FKAlertSingleController ()
...
@implementation FKAlertSingleController
...
- (void)showAlertWithController:(UIViewController *)controller title:(NSString *)title content:(NSString *)content sureClickBlock:(void(^)(void))sureClickBlock sureCompletion:(void(^)(void))sureCompletion{
    [self showAlertWithController:controller title:title content:content sureButtonTitle:@"确定" sureClickBlock:sureClickBlock sureCompletion:sureCompletion];
}
