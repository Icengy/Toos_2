...
//黑色
#define kLYBlackColor [UIColor colorWithRed:0.3f green:0.3f blue:0.3f alpha:1.f]
//灰色
#define kLYGrayColor [UIColor colorWithRed:0.5f green:0.5f blue:0.5f alpha:1.f]
...
- (void)setupTitleLabel:(NSString *)titleStr{
    ...
    UIColor *textColor = self.titleLabTextColor ? self.titleLabTextColor : kLYBlackColor;
...
- (void)setupDetailLabel:(NSString *)detailStr{
    ...
    UIColor *textColor = self.detailLabTextColor ? self.detailLabTextColor : kLYGrayColor;
...
- (void)setupActionBtn:(NSString *)btnTitle target:(id)target action:(SEL)action btnClickBlock:(LYActionTapBlock)btnClickBlock{
    ...
    CGFloat fontSize = font.pointSize;
    UIColor *titleColor = self.actionBtnTitleColor ?: kLYBlackColor;
