...
- (void)configurePropertys
{
    ...
    _curIndex = self.defaultIndex;
    _curProgressIndex = self.defaultIndex;
    _preOffsetX = CGRectGetWidth(_contentView.frame) *self.defaultIndex;
    _scrollAnimated = YES;
...
- (void)reSizeContentView
{
	...
	_contentView.scrollEnabled = _contentScrollEnabled;
