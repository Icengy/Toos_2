...
@implementation UITextView (AMPlaceholder)
...
- (void)setPlaceholderFont:(UIFont *)placeholderFont {
	self.placeholdLabel.font = placeholderFont;
	[self updateLabel];
}

- (UIFont *)placeholderFont {
	return self.placeholdLabel.font;
}
...
- (void)updateLabel
{
	...
	self.textContainerInset = UIEdgeInsetsMake(8.0f, 10.0f, 8.0f, 8.0f);
    ...
    if (self.height <= 44.0f) {
        labelY = (self.height - labelH)/2;
        self.textContainerInset = UIEdgeInsetsMake(labelY, 10.0f, labelY, 8.0f);
    }
