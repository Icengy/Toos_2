...
//    [self.navigationController.navigationBar setBarTintColor:Color_Whiter];
    [self.navigationController.navigationBar setTintColor:Color_Whiter];
        // 导航栏文字颜色+字号
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:Color_Whiter}];
...
-(void)viewWillDisappear:(BOOL)animated {
    ...
    [self.navigationController.navigationBar setTintColor:Color_Black];
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:Color_Black}];
    [self.navigationController.navigationBar setShadowImage:[UIImage imageWithColor:RGB(230, 230, 230)]];
