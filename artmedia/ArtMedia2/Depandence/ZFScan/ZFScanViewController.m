 ...
 */
- (void)addUI{
    self.maskView = [[ZFMaskView alloc] initWithFrame:CGRectMake(0, 0, K_Width, K_Height)];
    ...
    if ([[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeLeft || [[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeRight){
        ...
        self.backButton.center = CGPointMake(100, K_Height / 2);;
        self.backHintLabel.center = CGPointMake(100, CGRectGetMaxY(self.backButton.frame) + CGRectGetHeight(self.backHintLabel.frame) / 2);
        self.flashlight.center = CGPointMake(K_Width - 100, K_Height / 2);
        self.flashlightHintLabel.center = CGPointMake(K_Width - 100, CGRectGetMaxY(self.flashlight.frame) + CGRectGetHeight(self.flashlightHintLabel.frame) / 2);
    
    //竖屏
    }else{
        self.backButton.center = CGPointMake(K_Width / 4, K_Height - 100);
        self.backHintLabel.center = CGPointMake(K_Width / 4, CGRectGetMaxY(self.backButton.frame) + CGRectGetHeight(self.backHintLabel.frame) / 2);
        self.flashlight.center = CGPointMake(K_Width / 4 * 3, K_Height - 100);
        self.flashlightHintLabel.center = CGPointMake(K_Width / 4 * 3, CGRectGetMaxY(self.flashlight.frame) + CGRectGetHeight(self.flashlightHintLabel.frame) / 2);
    }
}
...
- (void)capture{
    ...
    self.previewLayer.frame = CGRectMake(0, 0, K_Width, K_Height);
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id <UIViewControllerTransitionCoordinator>)coordinator{
    ...
    if ([[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeLeft || [[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeRight) {
        ...
        self.backButton.center = CGPointMake(K_Height / 4, K_Width - 100);
        self.backHintLabel.center = CGPointMake(K_Height / 4, CGRectGetMaxY(self.backButton.frame) + CGRectGetHeight(self.backHintLabel.frame) / 2);
        self.flashlight.center = CGPointMake(K_Height / 4 * 3, K_Width - 100);
        self.flashlightHintLabel.center = CGPointMake(K_Height / 4 * 3, CGRectGetMaxY(self.flashlight.frame) + CGRectGetHeight(self.flashlightHintLabel.frame) / 2);
    
    //竖屏(转之前是竖屏，转之后是横屏)
    }else{
        self.backButton.center = CGPointMake(100, K_Width / 2);
        self.backHintLabel.center = CGPointMake(100, CGRectGetMaxY(self.backButton.frame) + CGRectGetHeight(self.backHintLabel.frame) / 2);
        self.flashlight.center = CGPointMake(K_Height - 100, K_Width / 2);
        self.flashlightHintLabel.center = CGPointMake(K_Height - 100, CGRectGetMaxY(self.flashlight.frame) + CGRectGetHeight(self.flashlightHintLabel.frame) / 2);
