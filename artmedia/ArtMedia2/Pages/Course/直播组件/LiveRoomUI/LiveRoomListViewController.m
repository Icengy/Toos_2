...
#pragma mark - Login
- (void)login {
    NSString *userID = [UserInfoManager shareManager].uid;
    NSString *userSig = [GenerateTestUserSig genTestUserSig:userID sdkAppId:(int)AM_SDKAppID secretKey:AM_SDKAppKey];
    
    MLVBLoginInfo *loginInfo = [MLVBLoginInfo new];
    loginInfo.sdkAppID = (int)AM_SDKAppID;//服务器获取
...
- (void)onCreateBtnClicked:(UIButton *)sender {
    ...
    newRoomController.userID   = [UserInfoManager shareManager].uid;
    newRoomController.userName = [UserInfoManager shareManager].model.username;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    vc.userName = [UserInfoManager shareManager].model.username;
