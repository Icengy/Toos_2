...
@property (copy, nonatomic) void(^completionCustom)(UGCKitResult *result);
/// 点击完成回调
@property (copy, nonatomic) void(^onTapFinishButton)(AMVideoEditer *videoEdit);
