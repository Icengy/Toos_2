...
@interface UGCKitRecordViewController()//TCBGMControllerListener
<TXUGCRecordListener, UIGestureRecognizerDelegate,
MPMediaPickerControllerDelegate,TXVideoJoinerListener,
UGCKitVideoRecordMusicViewDelegate, UGCKitAudioEffectPanelDelegate, BeautyLoadPituDelegate, UGCKitVideoRecordMusicViewDelegate, UGCKitBGMControllerListener
#if POD_PITU
...
- (UGCKitVideoRecordMusicView *)musicView {
    ...
    _musicView = [[UGCKitVideoRecordMusicView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_btnBack.frame), self.view.ugckit_width, self.view.ugckit_bottom - CGRectGetMaxY(_btnBack.frame)) needEffect:YES theme:_theme];
