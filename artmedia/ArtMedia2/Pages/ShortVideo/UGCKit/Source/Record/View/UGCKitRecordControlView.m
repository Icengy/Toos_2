...
//                                            _btnCountDown, _btnAudioEffect];
    NSArray<UIView *> *rightSideControls = @[_btnRatioGroup, _btnBeauty];
    ...
    // 底部按钮
    CGRect bottomFrame = CGRectMake(0, self.frame.size.height - BUTTON_MASK_HEIGHT - safeEdgeInsets.bottom, self.frame.size.width, BUTTON_MASK_HEIGHT);
