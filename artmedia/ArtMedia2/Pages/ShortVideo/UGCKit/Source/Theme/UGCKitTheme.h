...
/// 贴纸文字-样式编辑页面-确认图标
@property (strong, nonatomic) UIImage *editSubtitleConfirmIcon;
/// 贴纸文字-样式编辑页面-取消图标
@property (strong, nonatomic) UIImage *editSubtitleCancelIcon;
/// 贴纸文字-样式编辑页面-滑块图标
@property (strong, nonatomic) UIImage *editSubtitleAddSliderIcon;
/// 贴纸文字-存在图标
@property (strong, nonatomic) UIImage *editSubtitleExistIcon;
